...
/**
  * Хийх зүйлсийн жагсаалтыг хадгалахын тулд зөвхөн localStorage ашиглана хийнэ.
*/
...
window.onload = function() {
  ...
  // Одоо байгаа хийх ажлын жагсаалтыг ачаалж, үзүүлэх
...
function deleteTasks() {
  ...
  // LocalStorage-г дахин тохируулах
  for(var key in localStorage) {
    if(key.indexOf(prefix) >= 0) {
